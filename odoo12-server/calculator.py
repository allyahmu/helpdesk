...
root = Tk()
root.title("Lwin Mar Aung Calculator")
...
btnSquare = Button(calc, text="ᶴ", width=6, height=2, font=("arial", 20, "bold"), bd=4, bg="powder blue",
...
btnPi = Button(calc, text="π", width=6, height=2, font=("arial", 20, "bold"), bd=4, bg="powder blue",
               command=added_value.pi).grid(row=1, column=5, pady=1)
...
btnMod = Button(calc, text="Mod", width=6, height=2, font=("arial", 20, "bold"), bd=4, bg="powder blue").grid(row=3,
                                                                                                              column=7,
                                                                                                              pady=1)
btnE = Button(calc, text="e", width=6, height=2, font=("arial", 20, "bold"), bd=4, bg="powder blue",
              command=added_value.e).grid(row=3, column=8, pady=1)

btnLog2 = Button(calc, text="Log2", width=6, height=2, font=("arial", 20, "bold"), bd=4, bg="powder blue",
                 command=added_value.log2).grid(row=4, column=5, pady=1)
...
btnExpm = Button(calc, text="Expm", width=6, height=2, font=("arial", 20, "bold"), bd=4, bg="powder blue",
                 command=added_value.expml).grid(row=5, column=7, pady=1)
btnIgamma = Button(calc, text="Igamma", width=6, height=2, font=("arial", 20, "bold"), bd=4, bg="powder blue",
                   command=added_value.lgamma).grid(row=5, column=8, pady=1)

lblDisplay = Label(calc, text="For You Baby", font=("arial", 30, "bold"), justify=CENTER)
lblDisplay.grid(row=0, column=4, columnspan=4)


# - - - - - - - - - - - - - - - - - - - - - MENU- - -  - - - - - - - - - -   - -
def iExit():
    iExit = tkinter.messagebox.askyesno("Lwin Mar Aung Calculator", "Confirm if you want to exit")
    if iExit > 0:
        root.destroy()
        return
...
menubar.add_cascade(label="May", menu=filemenu)
editmenu.add_command(label="Love u")
editmenu.add_command(label="Copy")
